...
5. CHECK
- 컬럼에 조건을 줘서 입력 값이 조건에 만족해야 하는것
- 데이터 입력시 조건 만족x => 에러

6. DEFAULT
- 컬럼에 입력 값이 없을때 자동적으로 어떤 값을 입력하는 것
...
VALUES ('TEST_ID_01', NULL, '010-1234-5678');   --not Null로 지정해서 오류
...
-- 실습 14-17
INSERT INTO TABLE_UNIQUE (LOGIN_ID, LOGIN_PWD, TEL)
VALUES ('TEST_ID_01', 'PWD01', '010-1234-5678');    --unique는 중복 데이터 저장 안

-- 실습 14-18
INSERT INTO TABLE_UNIQUE(LOGIN_ID, LOGIN_PWD, TEL)
VALUES('TEST_ID_02', 'PWD01', '010-1234-5678');됨

SELECT * FROM TABLE_UNIQUE;

-- 실습 14-19
INSERT INTO TABLE_UNIQUE(LOGIN_ID, LOGIN_PWD, TEL)
VALUES(NULL, 'PWD01', '010-2345-6789'); --null값은 저장 가능
...
UPDATE TABLE_UNIQUE
 ...
 WHERE LOGIN_ID IS NULL;    --중복 저장 안돼서 오류
...
-- 실습 14-25
ALTER TABLE TABLE_UNIQUE    --null로 바꾸니까 변경됨
MODIFY(TEL UNIQUE);
...
-- 실습 14-34
INSERT INTO TABLE_PK(LOGIN_ID, LOGIN_PWD, TEL)
VALUES('TEST_ID_01', 'PWD02', '010-2345-6789'); --중복 저장 안됨 

-- 실습 14-35
INSERT INTO TABLE_PK(LOGIN_ID, LOGIN_PWD, TEL)
VALUES(NULL, 'PWD02', '010-2345-6789'); --null값 저장 안됨 
...
VALUES ('TEST_ID', '123', '010-1234-5678'); --3자리 이하여서 오

-- 실습 14-47
INSERT INTO TABLE_CHECK
VALUES ('TEST_ID', '1234', '010-1234-5678');류
...
--Q1
--1) 다음과 같은 특성 및 제약조건을 지정하여 DEPT_CONST 테이블을 만들어라
...
--2) 다음과 같은 특성 및 제약조건을 지정하여 EMP_CONST 테이블을 만들어라
...
--3) 테이블 생성 후 데이터 사전 뷰를 사용해 다음과 같이 두 테이블의 제약조건을 확인해라
